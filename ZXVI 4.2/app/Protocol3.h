...
#define CODE_WJZL        0x05
#define CODE_WJZH        0x06
#define CODE_DJZ         0x07

#define CODE_SETEN       0x08
//设置探头数量
#define CODE_SETCNT      0x09
//设置当前模块地址
#define CODE_SET_ADDR    0x0A
#define CODE_RESET       0x0B             //地址为0

//读取当前探头的类型
#define CODE_READ_TYPE   0x0C

#define CODE_GET_ADDR    0x0D
//三代扩展命令
//设置报警值
#define CODE_SET_WARNING   0x0E
//设置脱扣值
#define CODE_SET_WARNING_W 0x0F
