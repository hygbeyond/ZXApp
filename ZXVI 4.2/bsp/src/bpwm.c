...
uint32_t BPWM_ConfigOutputChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    (bpwm)->WGCTL0 &= ~(BPWM_WGCTL0_ZPCTL0_Msk << (u32ChannelNum * 2 + BPWM_WGCTL0_PRDPCTL0_Pos));
    (bpwm)->WGCTL0 |= (BPWM_OUTPUT_LOW << (u32ChannelNum * 2 + BPWM_WGCTL0_PRDPCTL0_Pos));
    (bpwm)->WGCTL0 &= ~(BPWM_WGCTL1_CMPDCTL0_Msk << (u32ChannelNum * 2 + BPWM_WGCTL1_CMPDCTL0_Pos));
