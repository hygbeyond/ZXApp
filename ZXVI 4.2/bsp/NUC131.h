...
#define CLK_CLKSEL3_BPWM0_S_Msk              (3ul << CLK_CLKSEL3_BPWM0_S_Pos)         /*!< CLK CLKSEL3: BPWM0_S Mask */

#define CLK_CLKSEL3_PWM1_S_Pos               17                                       /*!< CLK CLKSEL3: PWM1_S Position */
#define CLK_CLKSEL3_PWM1_S_Msk               (3ul << CLK_CLKSEL3_PWM1_S_Pos)          /*!< CLK CLKSEL3: PWM1_S Mask */

#define CLK_CLKSEL3_PWM0_S_Pos               16                                       /*!< CLK CLKSEL3: PWM0_S Position */
#define CLK_CLKSEL3_PWM0_S_Msk               (3ul << CLK_CLKSEL3_PWM0_S_Pos)          /*!< CLK CLKSEL3: PWM0_S Mask */
...
typedef struct
{
     ...
     * |        |          |Bits PF0_BPWM14 (ALT_MFP3[22]) and GPF_MFP0 determine the PF.0 function.
     * |        |          |(PF0_BPWM14, GPF_MFP0) value and function mapping is as following list.
     * |        |          |(0, 0) = GPIO function is selected.
     ...
     * |        |          |Bits PF1_BPWM15 (ALT_MFP3[23]) and GPF_MFP1 determine the PF.1 function.
     * |        |          |(PF1_BPWM15, GPF_MFP1) value and function mapping is as following list.
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = XT1_IN function is selected.
     * |        |          |(1, 0) = BPWM1_CH5 function is selected.
     * |        |          |Note: This bit is read only and is decided by user configuration CGPFMFP (CONFIG0[27]).
     ...
     * |        |          |(0, 1) = CLKO function is selected.
     * |        |          |(1, 1) = BPWM1_CH3 function is selected.
     * |[22]    |PF0_BPWM14|PF.0 Pin Alternative Function Selection
     * |        |          |Bits PF0_BPWM14 (ALT_MFP3[22]) and GPF_MFP0 determine the PF.0 function.
     * |        |          |(PF0_BPWM14, GPF_MFP0) value and function mapping is as following list.
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = XT1_OUT function is selected.
     * |        |          |(1, 0) = BPWM1_CH4 function is selected.
     * |[23]    |PF1_BPWM15|PF.1 Pin Alternative Function Selection
     * |        |          |Bits PF1_BPWM15 (ALT_MFP3[23]) and GPF_MFP1 determine the PF.1 function.
     * |        |          |(PF1_BPWM15, GPF_MFP1) value and function mapping is as following list.
     * |        |          |(0, 0) = GPIO function is selected.
     * |        |          |(0, 1) = XT1_IN function is selected.
...
#define SYS_ALT_MFP3_PF1_BPWM15_Pos             23                                          /*!< GCR ALT_MFP3: PF1_BPWM15 Position */
#define SYS_ALT_MFP3_PF1_BPWM15_Msk             (1ul << SYS_ALT_MFP3_PF1_BPWM15_Pos)        /*!< GCR ALT_MFP3: PF1_BPWM15 Mask */

#define SYS_ALT_MFP3_PF0_BPWM14_Pos             22                                          /*!< GCR ALT_MFP3: PF0_BPWM14 Position */
#define SYS_ALT_MFP3_PF0_BPWM14_Msk             (1ul << SYS_ALT_MFP3_PF0_BPWM14_Pos)        /*!< GCR ALT_MFP3: PF0_BPWM14 Mask */
